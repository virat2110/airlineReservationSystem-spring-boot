...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
    ...
    <form action="AddFlight" method="post">
        ...
        <input type="text" name="t2"  class="email" placeholder ="name" required/>
         <input type="text" name="t3"  class="email" placeholder ="Source" required/>
         <input type="text" name="t4"  class="email" placeholder ="Destination" required/>
         <input type="text" name="t5"  class="email" placeholder ="Departure" required/>
         <input type="text" name="t6"  class="email" placeholder ="Arrival" required/>
         <input type="number" name="t7"  class="email" placeholder ="Price" required/>
